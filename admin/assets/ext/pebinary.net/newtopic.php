...
$newquestionen = cleanstring($_REQUEST['newquestionen']);
$newquestionth = cleanstring($_REQUEST['newquestionth']);
$section = cleanstring($_REQUEST['section']);

if (!$newquestionen) { echo "Error: No question provided.\n"; exit; }
if (!$newquestionth) { echo "Error: คุณยังไม่ได้พิมพ์คำถาม\n"; exit; }
