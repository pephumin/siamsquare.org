!function() {
        ...
        if ("string" == typeof o && l) {
            if (!n && l.length > 1 && t(l, "") > -1 && (a = RegExp(this.source, i.replace.call(e(this), "g", "")), i.replace.call(o.slice(l.index), a, function() {
                ...
                for (var h = 1; h < l.length; h++)
                    r = this._xregexp.captureNames[h - 1], r && (l[r] = l[h]);
    ...
    Object.defineProperties || (Object.defineProperties = function(e, t) {
        for (var i in t)
            g(t, i) && Object.defineProperty(e, i, t[i]);
        return e
    ...
    function i(e, t, i) {
        ...
        if (i in s.MODIFIER_KEYS && (i = -1), 8 & n && (91 === i || 93 === i) && (i = -1), !n && 13 === i) {
            var h = "location" in t ? t.location : t.keyLocation;
            if (3 === h && (e(t, n, -i), t.defaultPrevented))
                return
        }
        if (o.isChromeOS && 8 & n) {
    ...
    t.addListener = function(e, t, i) {
        ...
        t.addListener(e, "mousedown", function(e) {
            ...
            if (e._clicks = h, n[s]("mousedown", e), h > 4)
                h = 0;
            else if (h > 1)
                return n[s](c[h], e)
                ...
                var b = !1,
                    $ = function(e) {
                        if (!b) {
                            var t = u.value;
                            if (!m && t && t != d)
                                return e && t == d[0] ? y.schedule() : (x(t), b = !0, h(), b = !1, void 0)
                        }
                    },
                    y = o.delayedCall($);
        ...
        function t() {
            ...
            if (t == s) {
                var r = a.renderer.pixelToScreenCoordinates(0, u.y).row,
                    c = u.$pos;
                if (r > a.session.documentToScreenRow(c.row, c.column))
                    return i()
            }
            if (d != n)
                if (d = n.text.join("<br/>"), h.setHtml(d), h.show(), a.on("mousewheel", i), e.$tooltipFollowsMouse)
                    o(u);
                else {
    ...
    function i(e) {
        function t(e, t) {
            ...
            if (!S || s || o)
                p.$blockScrolling += 1, p.moveCursorToPosition(e), p.$blockScrolling -= 1, S = i, k = {
                    x: F,
                    y: w
                };
            else {
    ...
    (function() {
        this.$setMaxTokenCount = function(e) {
            ...
            for (var l, h = [], c = 0, u = 0, d = {
                ...
                if (m)
                    if ("string" == typeof g)
                        f && f.merge === !1 || d.type !== g ? (d.type && h.push(d), d = {
                            type: g,
                            value: m
                        }) : d.value += m;
                    else if (g) {
    ...
    (function() {
        this.addRules = function(e, t) {
            ...
            if (this.addRules(r, t), n)
                for (var h = Array.prototype[o ? "push" : "unshift"], a = 0; a < s.length; a++)
                    h.apply(this.$rules[s[a]], i.deepCopy(n));
                ...
                for (var a = 0; a < r.length; a++) {
                    ...
                    if (l.push && (l.nextState = l.next || l.push, l.next = e, delete l.push), l.rules)
                        for (var u in l.rules)
                            s[u] ? s[u].push && s[u].push.apply(s[u], l.rules[u]) : s[u] = l.rules[u];
        ...
        this.tokenRe = new RegExp("^[" + o.packages.L + o.packages.Mn + o.packages.Mc + o.packages.Nd + o.packages.Pc + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + o.packages.L + o.packages.Mn + o.packages.Mc + o.packages.Nd + o.packages.Pc + "\\$_]|\\s])+", "g"), this.getTokenizer = function() {
            ...
            if (this.lineCommentStart) {
                if (Array.isArray(this.lineCommentStart))
                    var d = this.lineCommentStart.map(r.escapeRegExp).join("|"),
                        g = this.lineCommentStart[0];
                else
                    var d = r.escapeRegExp(this.lineCommentStart),
    ...
    t.applyDelta = function(e, t) {
        ...
        case "insert":
            var o = t.lines;
            if (1 === o.length)
                e[i] = s.substring(0, n) + t.lines[0] + s.substring(n);
            else {
    ...
    var i = e("./lib/oop"),
        ...
        s = function(e) {
            ...
            this.$worker = function() {
                if (t.running) {
                    for (var e = new Date, i = t.currentLine, n = -1, s = t.doc, o = i; t.lines[i];)
                        i++;
                    var r = s.getLength(),
                        a = 0;
                    for (t.running = !1; r > i;) {
            ...
            if (this.regExp)
                for (var r = o.firstRow, a = o.lastRow, l = r; a >= l; l++) {
                    ...
                    for (var c = h.length; c--;)
                        t.drawSingleLineMarker(e, h[c].toScreenRange(s), this.clazz, o)
                }
        }
    ...
    (function() {
        this.shiftRow = function(e) {
            ...
            for (var h = 0; h < a.length; h++) {
                if (n = a[h], s = n.range.compareStart(t, i), -1 == s)
                    return void e(null, t, i, r, l);
                if (o = e(null, n.start.row, n.start.column, r, l), o = !o && e(n.placeholder, n.start.row, n.start.column, r), o || 0 === s)
                    return;
            ...
            for (var o = 0; o < n.length; o++) {
                ...
                if (2 != r) {
                    ...
                    for (var a = n[o].folds, l = 0; l < a.length; l++) {
                        var h = a[l];
                        if (r = h.range.compareRange(e), -2 == r)
                            break;
                        if (2 != r) {
                            if (42 == r)
                                break;
    ...
    (function() {
        ...
        i.implement(this, o), this.setDocument = function(e) {
            ...
            for (var h = 1; h < e.length; h++)
                r = e[h], n(r) ? (o = r.start, -1 == s.compare(o.row, o.column) && s.setStart(o), o = r.end, 1 == s.compare(o.row, o.column) && s.setEnd(o), a = !0) : (o = r.start, -1 == s.compare(o.row, o.column) && (s = l.fromPoints(r.start, r.start)), a = !1);
            if (null != i) {
            ...
            var i,
                ...
                a = this.$wrapLimit,
                l = e;
            for (t = Math.min(t, s.length - 1); t >= l;)
                n = this.getFoldLine(l, n), n ? (i = [], n.walk(function(e, t, n, o) {
                    var r;
                    if (null != e) {
        ...
        this.$computeWrapSplits = function(e, t, i) {
            ...
            for (var o = [], a = e.length, l = 0, c = 0, u = this.$wrapAsCode, A = this.$indentedSoftWrap, C = t <= Math.max(2 * i, 8) || A === !1 ? 0 : Math.floor(t / 2), v = 0; a - l > t - v;) {
                ...
                if (e[F - 1] >= f && e[F] >= f)
                    ...
                    for (var w = Math.max(F - (t - (t >> 2)), l - 1); F > w && e[F] < h;)
                        F--;
                    if (u) {
                        for (; F > w && e[F] < h;)
                            F--;
            ...
            for (var a = 0; a < i.length; a++) {
                ...
                if (9 == l) {
                    ...
                    32 == l ? o.push(f) : l > 39 && 48 > l || l > 57 && 64 > l ? o.push(g) : l >= 4352 && e(l) ? o.push(t, r) : o.push(t)
            }
            return o
            ...
            if (c && h >= 0)
                ...
                var u = !c;
            for (var d = this.getLength() - 1, g = this.getNextFoldLine(s), f = g ? g.start.row : 1 / 0; e >= r && (a = this.getRowLength(s), !(r + a > e || s >= d));)
                r += a, s++, s > f && (s = g.end.row + 1, g = this.getNextFoldLine(s, g), f = g ? g.start.row : 1 / 0), u && (this.$docRowCache.push(s), this.$screenRowCache.push(r));
            if (g && g.start.row <= s)
                i = this.getFoldDisplayLine(g), s = g.start.row;
            else {
                if (e >= r + a || s > d)
                    return {
                        row: d,
        ...
        this.set = function(e) {
            ...
            return i.forEach(function(e, i, o) {
                if (e.start)
                    ...
                    var r = e.offset + (o || 0);
                    if (n = new s(i, r, i, r + e.length), !e.length && t.start && t.start.start && 0 != t.skipCurrent && n.isEqual(t.start))
                        return n = null, !1
                }
                return !0
            }), n
            ...
            if (t.$isMultiLine) {
                var l,
                    ...
                    c = o.length - h;
                e:
                for (var u = a.offset || 0; c >= u; u++) {
                    for (var d = 0; h > d; d++)
                        if (-1 == o[u + d].search(a[d]))
                            continue e;
                    var g = o[u],
                        f = o[u + h - 1],
            ...
            if (n) {
                for (var F = n.start.column, w = n.start.column, A = 0, d = r.length - 1; d > A && r[A].start.column < F && r[A].start.row == n.start.row;)
                    A++;
                for (; d > A && r[d].end.column > w && r[d].end.row == n.end.row;)
                    d--;
                for (r = r.slice(A, d + 1), A = 0, d = r.length; d > A; A++)
            ...
            if (t.$isMultiLine)
                var r = n.length,
                    a = function(t, i, a) {
                        ...
                        if (-1 != l) {
                            for (var h = 1; r > h; h++)
                                if (t = e.getLine(i + h), -1 == t.search(n[h]))
                                    return;
    ...
    n.prototype = i.prototype, function() {
        ...
        this.addCommand = function(e) {
            ...
            var t = e.toLowerCase().split(/[\-\+]([\-\+])?/).filter(function(e) {
                ...
                i = t.pop(),
                n = s[i];
            if (s.FUNCTION_KEYS[n])
                i = s.FUNCTION_KEYS[n].toLowerCase();
            else {
                if (!t.length)
                    return {
                        key: i,
    ...
    (function() {
        i.implement(this, g), this.$initOperationListeners = function() {
            ...
            if (this.session.$bracketHighlight && (this.session.removeMarker(this.session.$bracketHighlight), this.session.$bracketHighlight = null), !this.$highlightPending) {
                ...
                this.$highlightPending = !0, setTimeout(function() {
                    ...
                    if (t && t.bgTokenizer) {
                        ...
                        if (i)
                            var n = new d(i.row, i.column, i.row, i.column + 1);
                    ...
                    if (t && t.bgTokenizer) {
                        ...
                        if (-1 == s.type.indexOf("tag-open") || (s = n.stepForward())) {
                            var o = s.value,
                                ...
                                a = n.stepBackward();
                            if ("<" == a.value) {
                                do a = s, s = n.stepForward(), s && s.value === o && -1 !== s.type.indexOf("tag-name") && ("<" === a.value ? r++ : "</" === a.value && r--);
                                while (s && r >= 0)
                            } else {
                                do s = a, a = n.stepBackward(), s && s.value === o && -1 !== s.type.indexOf("tag-name") && ("<" === a.value ? r++ : "</" === a.value && r--);
                                while (a && 0 >= r);
                                n.stepForward()
                            }
                            if (!s)
            ...
            if (this.session.getUseSoftTabs())
                ...
                for (var h = l % a; " " == o[t.start.column] && h;)
                    t.start.column--, h--;
            ...
            if (!s.inMultiSelectMode || this.inVirtualSelectionMode) {
                ...
                for (var a = 0, l = 0, h = r.length, c = 0; h > c; c++) {
                    ...
                    for (c--, a = this.session.$moveLines(d, g, t ? 0 : e), t && -1 == e && (u = c + 1); c >= u;)
                        r[u].moveBy(a, 0), u++;
                    t || (a = 0), l += a
                }
            ...
            if (o) {
                ...
                do {
                    if (o.value.match(/[{}()\[\]]/g)) {
                        ...
                        o && -1 !== o.type.indexOf("tag-name") && (isNaN(h[o.value]) && (h[o.value] = 0), "<" === s.value ? h[o.value]++ : "</" === s.value && h[o.value]--, -1 === h[o.value] && (r = "tag", l = !0));
                ...
                if (r) {
                    var g,
                        f;
                    if ("bracket" === r)
                        g = this.session.getBracketRange(i), g || (g = new d(n.getCurrentTokenRow(), n.getCurrentTokenColumn() + c - 1, n.getCurrentTokenRow(), n.getCurrentTokenColumn() + c - 1), f = g.start, (t || f.row === i.row && Math.abs(f.column - i.column) < 2) && (g = this.session.getBracketRange(f)));
                    else if ("tag" === r) {
                        ...
                        if (g = new d(n.getCurrentTokenRow(), n.getCurrentTokenColumn() - 2, n.getCurrentTokenRow(), n.getCurrentTokenColumn() - 2), 0 === g.compare(i.row, i.column)) {
                            l = !1;
                            do o = s, s = n.stepBackward(), s && (-1 !== s.type.indexOf("tag-close") && g.setEnd(n.getCurrentTokenRow(), n.getCurrentTokenColumn() + 1), o.value === m && -1 !== o.type.indexOf("tag-name") && ("<" === s.value ? h[m]++ : "</" === s.value && h[m]--, 0 === h[m] && (l = !0)));
                            while (s && !l)
                        }
    ...
    (function() {
        ...
        this.$padding = 0, this.setPadding = function(e) {
            ...
            for (var a = this.session, l = n.start.row, h = n.end.row, c = l, u = 0, d = 0, g = a.getScreenLastRowColumn(c), f = new i(c, n.start.column, c, d); h >= c; c++)
                f.start.row = f.end.row = c, f.start.column = c == l ? n.start.column : a.getRowWrapIndent(c), f.end.column = g, u = d, d = g, g = h > c + 1 ? a.getScreenLastRowColumn(c + 1) : c == h ? 0 : n.end.column, this.drawSingleLineMarker(t, f, s + (c == l ? " ace_start" : "") + " ace_br" + e(c == l || c == l + 1 && n.start.column, d > u, d > g, c == h), o, c == h ? 0 : 1, r)
    ...
    (function() {
        i.implement(this, o), this.EOF_CHAR = "¶", this.EOL_CHAR_LF = "¬", this.EOL_CHAR_CRLF = "¤", this.EOL_CHAR = this.EOL_CHAR_LF, this.TAB_CHAR = "—", this.SPACE_CHAR = "·", this.$padding = 0, this.$updateEolChar = function() {
            ...
            for (var t = this.$tabStrings = [0], i = 1; e + 1 > i; i++)
                t.push(this.showInvisibles ? "<span class='ace_invisible ace_invisible_tab'>" + s.stringRepeat(this.TAB_CHAR, i) + "</span>" : s.stringRepeat(" ", i));
            ...
            for (var s = this.element.ownerDocument.createDocumentFragment(), o = t, r = this.session.getNextFoldLine(o), a = r ? r.start.row : 1 / 0; o > a && (o = r.end.row + 1, r = this.session.getNextFoldLine(o, r), a = r ? r.start.row : 1 / 0), !(o > i);) {
                var l = n.createElement("div"),
                    h = [];
                if (this.$renderLine(h, o, !1, o == a ? r : !1), l.innerHTML = h.join(""), this.$useLineGroups())
                    l.className = "ace_line_group", s.appendChild(l), l.style.height = e.lineHeight * this.session.getRowLength(o) + "px";
                else
                    for (; l.firstChild;)
            ...
            this.config = e;
            for (var t = [], i = e.firstRow, n = e.lastRow, s = i, o = this.session.getNextFoldLine(s), r = o ? o.start.row : 1 / 0; s > r && (s = o.end.row + 1, o = this.session.getNextFoldLine(s, o), r = o ? o.start.row : 1 / 0), !(s > n);)
            ...
            var o = this,
                ...
                a = function(e, i, n, r) {
                    if (i)
                        return o.showInvisibles ? "<span class='ace_invisible ace_invisible_space'>" + s.stringRepeat(o.SPACE_CHAR, e.length) + "</span>" : e;
                    if ("&" == e)
                        return "&#38;";
                    if ("<" == e)
                        return "&#60;";
            ...
            for (var o = 0, r = 0, a = i[0], l = 0, h = 0; h < t.length; h++) {
                ...
                if (0 == h && this.displayIndentGuides) {
                    if (o = u.length, u = this.renderIndentGuide(e, u, a), !u)
                        continue;
                    o -= u.length
                }
                if (o + u.length < a)
                    l = this.$renderToken(e, l, c, u), o += u.length;
                else {
                    for (; o + u.length >= a;)
                        l = this.$renderToken(e, l, c, u.substring(0, a - o)), u = u.substring(a - o), o = a, n || e.push("</div>", "<div class='ace_line' style='height:", this.config.lineHeight, "px'>"), e.push(s.stringRepeat(" ", i.indent)), r++, l = 0, a = i[r] || Number.MAX_VALUE;
    ...
    function n(e) {
        ...
        if (0 === h) {
            ...
            if (u.$mouseHandler.$enableJumpToDef)
                a && n || l && n ? c = r ? "block" : "add" : n && u.$blockSelectEnabled && (c = "block");
            else if (l && !n) {
                if (c = "add", !g && r)
                    return
            } else
                n && u.$blockSelectEnabled && (c = "block");
    ...
    (function() {
        this.foldingStartMarker = null, this.foldingStopMarker = null, this.getFoldWidget = function(e, t, i) {
            ...
            if (r)
                return r.column++, o.column--, i.fromPoints(r, o)
        }
    }).call(n.prototype)
    ...
    function n(e, t, n) {
        ...
        if (s.length) {
            ...
            if (a && n) {
                ...
                var l = [];
                t = a.row;
                do l[0 > n ? "unshift" : "push"](a), a = s[o += n];
                while (a && a.row == t);
                return l.length && l
            }
        }
    ...
    e("./worker/worker_client"), e("./keyboard/hash_handler"), e("./placeholder"), e("./multi_select"), e("./mode/folding/fold_mode"), e("./theme/textmate"), e("./ext/error_marker"), t.config = e("./config"), t.require = e, t.edit = function(e) {
        ...
        if (e && /input|textarea/i.test(e.tagName)) {
            ...
            e && (r = i.getInnerText(e), e.innerHTML = "");
