...
$DB_PREFIX = "x_";   // If you want your database tables to use a prefix, set it here.
...
//$ESPCONFIG['adodb_pathto_db'] = "/www/default/siamsquare.org/scripts/db/esp.dbm";
...
//$ESPCONFIG['email_from_address'] = "survey@". $_SERVER['SERVER_NAME'];
...
$ESPCONFIG['email_return_path'] = "survey@siamsquare.org";
# example:
